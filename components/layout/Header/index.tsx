...
const Header: FC = () => {
  ...
  return (
    <>
      <header className="flex w-full bg-secondary z-50 items-center justify-center pb-0 py-3"> {/* Adjusted z-index to 50 */}
        ...
        <div className="w-full hidden lg:block">
          ...
          <div id="2" className="sticky top-0 w-full h-6 bg-primary" />
        </div>
      </header>
